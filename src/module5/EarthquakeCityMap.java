...
public class EarthquakeCityMap extends PApplet {
	...
	public void mouseClicked()
	{
		...
		if (lastClicked != null){
			...
			// If an EarthquakeMarker is clicked hide all other earthquake
			// markers and show the cities within the threat circle of that marker.
			...
			// If an CityMarker is clicked hide all other city
			// markers and show the cities within the threat circle of that marker. 
